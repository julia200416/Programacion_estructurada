...
public class listas {
   ...
   public void Eliminarenposicion(int posicion, int valor){
    ...
    if(isEmptyList() || posicion < 0 || posicion >= Longitud) {
   ...
   /*public void eliminarNodo (int posicion){
    ...
    public void mostrarNodoEnPosicion(int posicion){
        ...
        if (valorNodo!=0) {
            System.out.println("El elemento en la posicion " + posicion + " del nodo es: " + valorNodo);
        }else{
            System.out.println("La posicion especificada no es valida");
        }
    }
    ...
    public void eliminarNodo(int posicion){
        ...
        if (posicion < Longitud) {
            ...
            Nodox nodoAEliminar = puntero.next;
